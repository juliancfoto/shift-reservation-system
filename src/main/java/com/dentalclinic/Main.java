...
public class Main {
   ...
   public static void main(String[] args) {
      ...
      *        - delete() DTO in Dentist and Patient services  -MISSING EXCEPTION
      *        - update() DTO in Dentist and Patient services  -MISSING EXCEPTION
      ...
      *  19. Create and use Exceptions  -IN PROGRESS
      *  .
      *  .
